...
if (isset($_POST['guardar'])) {
	...
	if (! isset($error)) {
		...
		$query = mysql_query("INSERT INTO terreno3 (calle, Ncalle, Aclaratoria, rol_sii, fojas, numeroCBR, anoCBR, avaluo_fiscal, superficie_terrenom2, comodato1, estado, resolucion, inicio, termino, entidad_ocupante) VALUES ('$calle','$Ncalle','$Aclaratoria','$rol_sii','$fojas','$numeroCBR','$anoCBR','$avaluo_fiscal','$superficie_terrenom2','$comodato1','$estado','$resolucion','$inicio','$termino','$entidad_ocupante')") 
			or die(mysql_error());
...
<!--migas de pan -->
	...
	<div class="breadcrum">
		<a href="comodatos.php">Inicio</a> >  Formulario de Ingreso > REGISTRO IND
	</div>
